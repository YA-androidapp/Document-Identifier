...
| バージョン | 内容                                            | 基準日時                 | 正規表現                                                                  | C#                                                                    | JavaScript                            | PHP [ramsey/uuid](https://github.com/ramsey/uuid)            | PHP [symfony/uid](https://github.com/symfony/uid)                         |     | PowerShell                                                                                     | [Python](https://docs.python.org/ja/3/library/uuid.html)       |      |     |
| ---------- | ----------------------------------------------- | ------------------------ | ------------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------------------- | --- | ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | ---- | --- |
...
| 4          | 乱数                                            |                          | `([0-9a-f]{8})-([0-9a-f]{4})-(4[0-9a-f]{3})-([0-9a-f]{4})-([0-9a-f]{12})` | [4](https://learn.microsoft.com/ja-jp/dotnet/api/system.guid.newguid) | [4](https://github.com/uuidjs/uuid)   | [4](https://uuid.ramsey.dev/en/stable/rfc4122/version4.html) | [4](https://symfony.com/doc/current/components/uid.html#generating-uuids) |     | [4](https://learn.microsoft.com/ja-jp/powershell/module/microsoft.powershell.utility/new-guid) | [4](https://docs.python.org/ja/3/library/uuid.html#uuid.uuid4) | []() |     |
| 5          | SHA-1                                           |                          | `([0-9a-f]{8})-([0-9a-f]{4})-(5[0-9a-f]{3})-([0-9a-f]{4})-([0-9a-f]{12})` |                                                                       | [5](https://github.com/uuidjs/uuid)   | [5](https://uuid.ramsey.dev/en/stable/rfc4122/version5.html) | [5](https://symfony.com/doc/current/components/uid.html#generating-uuids) |     | [5](https://qiita.com/h53/items/b85aa2fb852f39b0c52e)                                          | [5](https://docs.python.org/ja/3/library/uuid.html#uuid.uuid5) | []() |     |
...
| (7)        | 時刻 ＋ 乱数                                    | ミリ秒Unixタイムスタンプ | `([0-9a-f]{8})-([0-9a-f]{4})-(7[0-9a-f]{3})-([0-9a-f]{4})-([0-9a-f]{12})` |                                                                       |                                       | [7](https://uuid.ramsey.dev/en/stable/rfc4122/version7.html) | [7](https://symfony.com/doc/current/components/uid.html#generating-uuids) |     |                                                                                                |                                                                | []() |     |
| (8)        | 任意                                            |                          | `([0-9a-f]{8})-([0-9a-f]{4})-(8[0-9a-f]{3})-([0-9a-f]{4})-([0-9a-f]{12})` |                                                                       |                                       | [8](https://uuid.ramsey.dev/en/stable/rfc4122/version8.html) | [8](https://symfony.com/doc/current/components/uid.html#generating-uuids) |     |                                                                                                |                                                                | []() |     |
